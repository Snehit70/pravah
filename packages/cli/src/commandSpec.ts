...
const taskCreateFields = [value("description", "<text>", "Description."), value("deadline", "<YYYY-MM-DD>", "Local scheduled date."), value("time", "<HH:MM>", "Local scheduled time."), value("priority", "<p1|p2|p3>", "Priority."), value("tags", "<tag,...>", "Comma-separated tags."), value("estimated-minutes", "<minutes>", "Positive estimate.")];
const taskEditFields = [value("description", "<text|clear>", "Description."), value("deadline", "<YYYY-MM-DD|clear>", "Local scheduled date."), value("time", "<HH:MM|clear>", "Local scheduled time."), value("priority", "<p1|p2|p3|clear>", "Priority."), value("tags", "<tag,...|clear>", "Comma-separated tags."), value("estimated-minutes", "<minutes|clear>", "Positive estimate.")];
